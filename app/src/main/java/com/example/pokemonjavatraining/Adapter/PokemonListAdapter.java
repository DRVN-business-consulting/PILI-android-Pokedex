package com.example.pokemonjavatraining.Adapter;
...
import com.example.pokemonjavatraining.MainActivity;
import com.example.pokemonjavatraining.Model.Pokemon;
import com.example.pokemonjavatraining.PokemonDetailsActivity;
import com.example.pokemonjavatraining.R;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent detailsPage = new Intent(mContext, PokemonDetailsActivity.class);
